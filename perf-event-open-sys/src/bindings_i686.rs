...
pub type _bindgen_ty_5 = ::std::os::raw::c_ulonglong;
...
const _: () = {
    ...
    ["Alignment of perf_event_attr__bindgen_ty_3"]
        [::std::mem::align_of::<perf_event_attr__bindgen_ty_3>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of perf_event_attr__bindgen_ty_4"]
        [::std::mem::align_of::<perf_event_attr__bindgen_ty_4>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of perf_event_mmap_page__bindgen_ty_1__bindgen_ty_1"]
        [::std::mem::align_of::<perf_event_mmap_page__bindgen_ty_1__bindgen_ty_1>() - 4usize];
};
...
const _: () = {
    ...
    ["Alignment of perf_event_mmap_page__bindgen_ty_1"]
        [::std::mem::align_of::<perf_event_mmap_page__bindgen_ty_1>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of perf_event_mmap_page"][::std::mem::align_of::<perf_event_mmap_page>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of perf_ns_link_info"][::std::mem::align_of::<perf_ns_link_info>() - 4usize];
...
pub type perf_callchain_context = ::std::os::raw::c_ulonglong;
#[repr(C)]
#[derive(Copy, Clone)]
...
const _: () = {
    ...
    ["Alignment of perf_mem_data_src__bindgen_ty_1"]
        [::std::mem::align_of::<perf_mem_data_src__bindgen_ty_1>() - 4usize];
};
...
const _: () = {
    ...
    ["Alignment of perf_mem_data_src"][::std::mem::align_of::<perf_mem_data_src>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of perf_branch_entry"][::std::mem::align_of::<perf_branch_entry>() - 4usize];
...
const _: () = {
    ...
    ["Alignment of perf_sample_weight"][::std::mem::align_of::<perf_sample_weight>() - 4usize];
...
pub const SET_FILTER: perf_event_ioctls = 1074013190;
pub const ID: perf_event_ioctls = 2147755015;
pub const SET_BPF: perf_event_ioctls = 1074013192;
pub const PAUSE_OUTPUT: perf_event_ioctls = 1074013193;
pub const QUERY_BPF: perf_event_ioctls = 3221496842;
pub const MODIFY_ATTRIBUTES: perf_event_ioctls = 1074013195;
