...
impl perf_mem_data_src__bindgen_ty_1 {
    ...
    pub fn mem_rsvd(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(0usize, 18u8) as u64) }
    }
    #[inline]
    ...
    pub fn mem_hops(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(18usize, 3u8) as u64) }
    }
    #[inline]
    ...
    pub fn mem_blk(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(21usize, 3u8) as u64) }
    }
    #[inline]
    ...
    pub fn mem_lvl_num(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(27usize, 4u8) as u64) }
    }
    #[inline]
    ...
    pub fn mem_dtlb(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(31usize, 7u8) as u64) }
    }
    #[inline]
    pub fn set_mem_dtlb(&mut self, val: __u64) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            self._bitfield_1.set(31usize, 7u8, val as u64)
        }
    }
    #[inline]
    ...
    pub fn mem_lvl(&self) -> __u64 {
        unsafe { ::std::mem::transmute(self._bitfield_1.get(45usize, 14u8) as u64) }
    }
    #[inline]
    pub fn set_mem_lvl(&mut self, val: __u64) {
        unsafe {
            let val: u64 = ::std::mem::transmute(val);
            self._bitfield_1.set(45usize, 14u8, val as u64)
        }
    }
    #[inline]
    ...
    pub fn new_bitfield_1(
        ...
        __bindgen_bitfield_unit.set(31usize, 7u8, {
        ...
        __bindgen_bitfield_unit.set(45usize, 14u8, {
...
const _: () = {
    ...
    ["Offset of field: perf_sample_weight__bindgen_ty_1::var3_w"]
        [::std::mem::offset_of!(perf_sample_weight__bindgen_ty_1, var3_w) - 0usize];
    ["Offset of field: perf_sample_weight__bindgen_ty_1::var2_w"]
        [::std::mem::offset_of!(perf_sample_weight__bindgen_ty_1, var2_w) - 2usize];
    ["Offset of field: perf_sample_weight__bindgen_ty_1::var1_dw"]
        [::std::mem::offset_of!(perf_sample_weight__bindgen_ty_1, var1_dw) - 4usize];
};
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
...
pub const ENABLE: perf_event_ioctls = 536880128;
pub const DISABLE: perf_event_ioctls = 536880129;
pub const REFRESH: perf_event_ioctls = 536880130;
pub const RESET: perf_event_ioctls = 536880131;
pub const PERIOD: perf_event_ioctls = 2148017156;
pub const SET_OUTPUT: perf_event_ioctls = 536880133;
pub const SET_FILTER: perf_event_ioctls = 2148017158;
pub const ID: perf_event_ioctls = 1074275335;
pub const SET_BPF: perf_event_ioctls = 2147755016;
pub const PAUSE_OUTPUT: perf_event_ioctls = 2147755017;
pub const QUERY_BPF: perf_event_ioctls = 3221758986;
pub const MODIFY_ATTRIBUTES: perf_event_ioctls = 2148017163;
